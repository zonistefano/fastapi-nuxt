<template>
  <div
    ref="containerRef"
    class="relative mx-auto flex h-fit w-fit items-center justify-center rounded-lg p-10"
  >
    <div class="flex size-full flex-col items-stretch justify-between gap-10">
      <div class="flex flex-row items-center justify-between">
        ...
        >
          <Icon name="devicon:googlecloud" size="24" />
        </div>
        <div
          ref="div5Ref"
      ...
      <div class="flex flex-row items-center justify-between gap-8">
        <div
          ...
          class="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:text-black"
        >
          <Icon name="logos:notion-icon" size="24" />
        </div>
        <div
          ref="div4Ref"
        ...
        >
          <Icon name="simple-icons:openai" size="30" />
        </div>
        <div
          ref="div6Ref"
          class="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]"
        >
          <Icon name="logos:google-gmail" size="24" />
        </div>
      </div>
      <div class="flex flex-row items-center justify-between">
        <div
          ...
          class="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:text-black"
        >
          <Icon name="logos:whatsapp-icon" size="24" />
        </div>
        <div
          ref="div7Ref"
          class="z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-2 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]"
        >
          <Icon name="logos:messenger" size="24" />
        </div>
      </div>
    </div>
